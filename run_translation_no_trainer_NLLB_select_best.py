...
MULTILINGUAL_TOKENIZERS = [MBartTokenizer, MBartTokenizerFast, MBart50Tokenizer, MBart50TokenizerFast,NllbTokenizerFast, NllbTokenizer]
...
def main():
    ...
    if model.config.decoder_start_token_id is None and isinstance(tokenizer, (MBartTokenizer, MBartTokenizerFast, NllbTokenizer, NllbTokenizerFast)):
        assert (
            args.target_lang is not None and args.source_lang is not None
        ), "mBart requires --target_lang and --source_lang"
        if isinstance(tokenizer, (MBartTokenizer, MBartTokenizerFast, NllbTokenizer, NllbTokenizerFast)):
            #print('####',  model.config.decoder_start_token_id)
    ...
    if isinstance(tokenizer, (MBartTokenizer, MBartTokenizerFast, MBart50Tokenizer, NllbTokenizer, NllbTokenizerFast)):
